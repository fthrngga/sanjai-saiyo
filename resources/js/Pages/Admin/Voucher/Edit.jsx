...
export default function Edit({ voucher }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        // Laravel PUT requests with files or general multipart data can be submitted via POST spoofing
        post(route('admin.vouchers.update', voucher.id));
    };
            ...
            <div className="w-full max-w-4xl mx-auto">
                ...
                <form onSubmit={submit} className="space-y-6">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        <h2 className="text-xl font-bold mb-6 text-gray-900">Edit Informasi Voucher</h2>
